import{$r as e,Ha as t,Vr as n,Wa as r,gi as i,wn as a}from"./index-lR-QVdnh.js";import{n as o,t as s}from"./IFrameUtil-BYTcNZ4E-B6kSJ_Ik.js";var c=r(t(),1),l=a(`iframe`,{target:`e1u6k47s0`})(({theme:e,disableScrolling:t,width:n,height:r})=>({width:n??`100%`,height:r??`100%`,colorScheme:`normal`,border:`none`,padding:e.spacing.none,margin:e.spacing.none,overflow:t?`hidden`:void 0}),``),u=`streamlit:iframe:setSize`,d=`25rem`,f=`<script>
(function() {
  var lastW = 0, lastH = 0;
  function sendSize() {
...
<\/script>`;function p(e){return e+f}function m(e){return n(e)||e===``?void 0:e}function h({element:t,widthConfig:n,heightConfig:r}){let a=m(t.src),f=i(a)?void 0:m(t.srcdoc),h=(0,c.useRef)(null),[g,_]=(0,c.useState)({width:null,height:null}),v=n?.useContent??!1,y=r?.useContent??!1,b=i(f)&&(v||y),x=b?p(f):f;(0,c.useEffect)(()=>{if(!b)return;let e=e=>{if(e.source&&e.source===h.current?.contentWindow){let t=e.data;if(t?.type===u&&typeof t?.width==`number`&&typeof t?.height==`number`&&Number.isFinite(t.width)&&Number.isFinite(t.height)&&t.width>=0&&t.height>=0){let e=t.width,n=t.height;_(t=>t.width===e&&t.height===n?t:{width:e,height:n})}}};return window.addEventListener(`message`,e),()=>{window.removeEventListener(`message`,e)}},[b]);let S=b&&v&&g.width!==null?`${g.width}px`:void 0,C;return y&&(b&&g.height!==null?C=`${g.height}px`:i(a)&&(C=d)),e.jsx(l,{ref:h,className:`stIFrame`,"data-testid":`stIFrame`,allow:o,disableScrolling:!t.scrolling,src:a,srcDoc:x,scrolling:t.scrolling?`auto`:`no`,sandbox:s,title:`st.iframe`,tabIndex:t.tabIndex??void 0,width:S,height:C})}var g=(0,c.memo)(h);export{g as default};